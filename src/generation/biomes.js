...
export class ContinentBiome extends Biome {}

export class IslandBiome extends Biome {
  biomePool;
  constructor(random) {
...
export class TaigaBiome extends Biome {
  biomePool;
  longitudeAverage;
  longitudeSigma;
...
export class PlainBiome extends Biome {
  biomePool;
  longitudeAverage;
  longitudeSigma;
...
export class JungleBiome extends Biome {
  biomePool;
  longitudeAverage;
  longitudeSigma;
...
export class SavanaBiome extends Biome {
  biomePool;
  longitudeAverage;
  longitudeSigma;
...
//Corrupted
export class CorruptedBiome extends Biome {
  biomePool;
  constructor(random) {
...
//Fairy
export class FairyBiome extends Biome {
  biomePool;
  constructor(random) {
