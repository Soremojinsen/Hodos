/**
 * French texts. en.js has the same keys (checked by tests/unit/i18n.test.js).
 * Texts may hold {parameters}; project.* texts are HTML.
 */
export default {
  "page.description": "Hodos, un générateur procédural de cartes du monde dans votre navigateur.",
  "map.zoomIn": "Zoom avant",
  "map.zoomOut": "Zoom arrière",
  "map.recenter": "Recentrer la carte",
  "map.fullscreen": "Plein écran",
  "map.exitFullscreen": "Quitter le plein écran",
  "map.download": "Télécharger la carte",
  ...
  "settings.seed": "Seed :",
  "settings.seedPlaceholder": "un mot ou un nombre",
  "settings.seedSubmit": "Changer",
  "settings.seedTooLong": "Seed trop longue ({max} caractères au plus).",
